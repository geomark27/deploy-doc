...
func printUsage() {
	...
	fmt.Print("  -s, --sprint           Número del sprint (omitir = modo Kanban) (opcional)\n")
	...
	fmt.Print("    Sprint  — con -s: busca tareas del sprint indicado\n")
	fmt.Print("    Kanban  — sin -s: busca tareas de los últimos 10 días hábiles\n\n")
	...
	fmt.Print("  gtt qa -m DAI                           # modo Kanban (últimos 10 días hábiles)\n")
